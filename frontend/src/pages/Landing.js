          ...
          <div className="lg:col-span-7">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-3">
              <Link to="/inscription" data-testid="hero-cta-primary" className="btn-primary">
                Démarrer 48h Premium offert <ArrowRight size={16} />
              </Link>
              <Link to="/themes" data-testid="hero-cta-secondary" className="btn-secondary">
                Voir les 15 thèmes
              </Link>
            </div>
            <p className="mt-3 text-xs text-zinc-500">Aucune carte bancaire requise · accès Premium illimité 48h offert à l'inscription</p>
